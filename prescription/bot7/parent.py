...
class PARENT:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls.driver = Edge(executable_path=driver_path)
    ...
    #     try:
    #         WebDriverWait(self.driver, 2).until(EC.presence_of_element_located((By.XPATH, "//button[@class='fc-close']")))
    ...
    #     try:
    #         WebDriverWait(self.driver, 2).until(EC.presence_of_element_located((By.CLASS_NAME, clas)))
